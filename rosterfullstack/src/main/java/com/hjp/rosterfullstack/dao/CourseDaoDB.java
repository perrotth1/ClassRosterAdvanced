...
import com.hjp.rosterfullstack.dao.StudentDaoDB.StudentMapper;
import com.hjp.rosterfullstack.dao.TeacherDaoDB.TeacherMapper;
...
public class CourseDaoDB implements CourseDao{
    ...
    public Course getCourseById(int id) {
        try {
            ...
            //fetch course object, which doesn't have all fields completed yet
            ...
            //We need to get the teacher and students fields with helper methods
